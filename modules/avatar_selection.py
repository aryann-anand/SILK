...
if __name__ == "__main__":
	...
	background = '#F6FAFB'
	avtrRoot = Tk()
	avtrRoot.title("Select your Avatar")
	...
	Label(avtrRoot, text="Select your Avatar", font=('arial bold', 15), bg=background, fg='#303E54').pack(pady=10)
	...
	avtr1 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a1.png').resize((size, size)), Image.ANTIALIAS)
	avtr2 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a2.png').resize((size, size)), Image.ANTIALIAS)
	avtr3 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a3.png').resize((size, size)), Image.ANTIALIAS)
	avtr4 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a4.png').resize((size, size)), Image.ANTIALIAS)
	avtr5 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a5.png').resize((size, size)), Image.ANTIALIAS)
	avtr6 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a6.png').resize((size, size)), Image.ANTIALIAS)
	avtr7 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a7.png').resize((size, size)), Image.ANTIALIAS)
	avtr8 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a8.png').resize((size, size)), Image.ANTIALIAS)
	avtr9 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a9.png').resize((size, size)), Image.ANTIALIAS)
	avtr10 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a10.png').resize((size, size)), Image.ANTIALIAS)
	avtr11 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a11.png').resize((size, size)), Image.ANTIALIAS)
	avtr12 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a12.png').resize((size, size)), Image.ANTIALIAS)
	avtr13 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a13.png').resize((size, size)), Image.ANTIALIAS)
	avtr14 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a14.png').resize((size, size)), Image.ANTIALIAS)
	avtr15 = ImageTk.PhotoImage(Image.open('assets/image/avatar/a15.png').resize((size, size)), Image.ANTIALIAS)
	...
	avtrRoot.iconbitmap("assets/image/changeProfile.ico")
	avtrRoot.mainloop()
