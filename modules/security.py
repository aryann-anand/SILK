...
try:
	face_classifier = cv2.CascadeClassifier('face_classifier/haarcascade_frontalface_default.xml')
...
def startLogin():		
	try:
		...
		if result:
			...
			welcLbl['text'] = 'Hi '+userName+',\nI am SILK, your virtual assistant.'
...
image1 = Image.open('assets/image/home2.jpg')
...
#welcome label
welcLbl = Label(root1, text='Hi there,\nI am SILK, your virtual assistant.', font=('Arial Bold', 15), fg='#303E54', bg=background)
...
image2 = Image.open('assets/image/defaultFace4.png')
...
usernameLbl = Label(root4, text="Aryan Anand", font=('Arial Bold',15), bg=background, fg='#85AD4F')
...
Label(root4, text="Launch SILK again to get started", font=('arial',13), bg=background, fg='#A3A5AB', wraplength=350).pack()
