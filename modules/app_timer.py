...
def timer():
	root = Tk()
	root.title("Timer - S.I.L.K")
	root.iconbitmap("assets/image/timer.ico")
	...
	Label(root, text="Time Up!", font=("Arial Bold", 20), bg='white').pack(pady=20)
...
def startTimer(query):
	...
	playsound.playsound("assets/sound/timer.mp3")
