...
def CreateHTMLProject(project_name='Sample'):
	...
	if os.path.isdir(path + project_name):
		...
		return "Yo BRUH!! You already cooked up a project like this. Check it out..."
	else:
	...
	appLocation = "C:\\Program Files\\Notepad++\\notepad++.exe"
	...
	return f"Project {project_name} created successfully!! - SILK"
